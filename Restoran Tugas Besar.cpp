...
void pesan_makanan(){
    string menu[11] = {"", "Batagor", "Seblak", "Bakso", "Rawon", "Soto", "Kopi", "Teh", "Susu", "Mojito", "Sprite"};
    int harga[11] = {0, 15000, 10000, 12000, 12500, 17000, 6500, 5000, 5000, 8500, 5000};
    string ulang;
...
void cari_menu(){
    ...
    if(pilihMakanan == hasil ){
        ...
        //Jika benar
        cout << "\t\t\t\tMenu di temukan - " << hasil << "\n";
    }else{
        //Jika salah
        cout << "\t\t\t\tMenu tidak di temukan pada -" << pilihMakanan << "\n";
    }
